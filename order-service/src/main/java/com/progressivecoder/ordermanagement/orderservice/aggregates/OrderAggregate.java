...
public class OrderAggregate {
    ...
    protected void on(OrderCreatedEvent orderCreatedEvent){
        ...
        this.userToken = orderCreatedEvent.userToken;
    }

    @CommandHandler
    protected void on(UpdateOrderStatusCommand updateOrderStatusCommand){
        AggregateLifecycle.apply(new OrderUpdatedEvent(updateOrderStatusCommand.orderId, updateOrderStatusCommand.orderStatus,updateOrderStatusCommand.userToken));
    }
    ...
    protected void on(OrderUpdatedEvent orderUpdatedEvent){
        ...
        this.userToken = orderUpdatedEvent.userToken;
    }
}
