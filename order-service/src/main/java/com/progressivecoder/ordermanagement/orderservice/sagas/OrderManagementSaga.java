...
public class OrderManagementSaga {
    ...
    public void handle(OrderCreatedEvent orderCreatedEvent){
        ...
        //send the commands
        commandGateway.send(new CreateInvoiceCommand(paymentId, orderCreatedEvent.orderId,orderCreatedEvent.userToken));
    }
    ...
    public void handle(InvoiceCreatedEvent invoiceCreatedEvent){
        ...
        commandGateway.send(new CreateShippingCommand(shippingId, invoiceCreatedEvent.orderId, invoiceCreatedEvent.paymentId,invoiceCreatedEvent.userToken));
    }

    @SagaEventHandler(associationProperty = "orderId")
    public void handle(OrderShippedEvent orderShippedEvent){
        commandGateway.send(new UpdateOrderStatusCommand(orderShippedEvent.orderId, String.valueOf(OrderStatus.SHIPPED),orderShippedEvent.userToken));
    }
