package com.progressivecoder.ordermanagement.orderservice.security.filter;
...
import com.progressivecoder.ordermanagement.orderservice.security.MyUserDetailsService;
import com.progressivecoder.ordermanagement.orderservice.security.model.AuthenticationResponse;
import com.progressivecoder.ordermanagement.orderservice.security.util.JwtUtil;
		...
		if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
			...
			if (jwtUtil.validateToken(jwt, userDetails)) {
				...
				if (null == authenticationResponse) {
					authenticationResponse = new AuthenticationResponse(username, jwt);
